        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-3">
            <select
              ...
              className="px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition appearance-none bg-white"
            >
            ...
            <input
              ...
              className="px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
              placeholder="From"
            />
            <input
              type="date"
            ...
            {(filters.search ||
              ...
              <button
                ...
                className="px-3 py-2 text-sm text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50 rounded-xl transition font-medium"
              >
                Clear Filters
              </button>
            )}
      ...
      <div className="divide-y divide-gray-50">
        {expenses.length === 0 ? (
          ...
          expenses.map((expense) => (
            <div
              key={expense.id}
              className="px-6 py-4 flex items-center gap-4 hover:bg-gray-50/50 transition group"
            >
              <div
